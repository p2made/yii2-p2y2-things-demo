...
```
composer require --prefer-dist p2made/yii2-p2y2-things-demo ">=0.9.7"
```

or

```
php composer.phar require --prefer-dist p2made/yii2-p2y2-things-demo ">=0.9.7"
```

Alternatively add:

```
"p2made/yii2-p2y2-things-demo": ">=0.9.7"
```
