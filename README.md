...
```
composer require --prefer-dist p2made/yii2-p2y2-things-demo ">=1.2.2"
```

or

```
php composer.phar require --prefer-dist p2made/yii2-p2y2-things-demo ">=1.2.2"
```

Alternatively add:

```
"p2made/yii2-p2y2-things-demo": ">=1.2.2"
```
