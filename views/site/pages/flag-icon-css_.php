	...
	<div class="container">
		...
		<section id="examples">
			...
			<div class="no-wrap">
				<h1>
					...
					'flag-icon flag-icon-squared flag-icon-au'
					<span class="label label-default">'flag-icon flag-icon-au' au</span>
					<span class="label label-primary">'flag-icon flag-icon-au' au</span>
					<span class="label label-success">'flag-icon flag-icon-au' au</span>
					<span class="label label-info">'flag-icon flag-icon-au' au</span>
					<span class="label label-warning">'flag-icon flag-icon-au' au</span>
					<span class="label label-danger">'flag-icon flag-icon-au' au</span>
				</h1>
				<h2>
					h2
					'flag-icon flag-icon-au'
			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-au'
					</div>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-es'
					</div>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-gb'
					</div>
				</div>
				<div class="col-lg-3 col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-dk'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-de'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-ru'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-is'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-fr'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-ge'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-ar'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-br'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-jp'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3 hidden-xs">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-in'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-sa'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-si'
					</div>
				</div>
				<div class="col-sm-2 col-xs-3 visible-lg">
					<div class="flag-wrapper">
						'img-thumbnail flag flag-icon-background flag-icon-ca'
					</div>
				</div>
			</div>
		</section>
		...
		<section class="all-flags">
			...
			<div class="row">
				...
				<div class="col-md-1 col-sm-2 col-xs-3">
					<div class="flag-wrapper">
						<div class="img-thumbnail flag flag-icon-background flag-icon-au" title="gr" id="gr"></div>
					</div>
				</div>
				<div class="col-md-1 col-sm-2 col-xs-3">
					<div class="flag-wrapper">
